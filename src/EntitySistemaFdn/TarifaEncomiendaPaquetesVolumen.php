...
{
    #[ORM\Column(name: 'volumen_minimo', type: 'decimal', precision: 12, scale: 2, nullable: true)] private ?string $volumenMinimo = null;
    #[ORM\Column(name: 'volumen_maximo', type: 'decimal', precision: 12, scale: 2, nullable: true)] private ?string $volumenMaximo = null;
